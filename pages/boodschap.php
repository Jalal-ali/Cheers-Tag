...
<body>
                ...
                <div class="hidden md:flex flex-1 justify-center items-center mx-auto">
                    <div class="flex space-x-4">
                        ...
                        <a href="./boodschap.html"
                            class="text-[#802311] hover:text-[#802311] px-3 py-2 text-sm font-bold">Maak je unieke
                            boodschap</a>
                        <a href="./werkt.html"
    ...
    <section>
        <div class="flex items-center justify-center p-4 md:p-2 md:mb-20 ">
    ...
    <div class="flex items-center gap-x-2">
        <div class="items-center p-1 md:p-2 rounded-full bg-[#f5e7d6]">
            <img src="../assets/icons/camera.svg" alt="camera" class="h-7 w-7 md:h-9 md:w-9">
        </div>
    ...
    <div class="flex items-center gap-x-2">
        <p class="text-[#722f37] text-sm md:text-base font-montserrat">€ 1.95</p>
        <input type="radio" name="payment" 
               class="appearance-none h-4 w-4 md:h-5 md:w-5 rounded-full border-2 border-gray-300 checked:border-[#722f37] checked:bg-[#722f37] checked:ring checked:ring-[#722f37] checked:ring-offset-2 transition-all" />
    </div>
</label>
                        ...
                        <label
                            ...
                            <!-- price and input section -->
                            <div class="flex items-center gap-x-2">
                                <p class="text-[#722f37] text-sm md:text-base font-montserrat">€ 2.95</p>
                                <input type="radio" name="payment"
                                    class="appearance-none h-4 w-4 md:h-5 md:w-5 rounded-full border-2 border-gray-300 checked:border-[#722f37] checked:bg-[#722f37] checked:ring checked:ring-[#722f37] checked:ring-offset-2 transition-all" />
                            </div>
                        </label>
                        ...
                        <label
                            ...
                            <div class="flex items-center gap-x-2">
                                <div class="items-center p-1 md:p-2 rounded-full bg-[#f5e7d6]">
                                    <img src="../assets/icons/video-camera.svg" alt="video-camera"
                                        class="h-7 w-7 md:h-9 md:w-9">
                                </div>
                                <div class="p-1 md:p-2">
                ...
                <div>
                    <button
                        class="hover:shadow-form w-full rounded-md bg-[#722f37] py-2 md:py-3 px-4 md:px-8 text-sm md:text-base font-semibold text-white outline-none">
                        Bericht versturen
                    </button>
                </div>
            </form>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-14 gap-4 lg:gap-8 pt-10 pb-4">
                ...
                <div class="lg:col-span-4 lg:col-start-7 md:col-span-1 md:col-start-2 text-center sm:text-center">
                    ...
                    <ul class="text-sm  transition-all duration-500">
                        ...
                        <li class="mb-3"><a href="./werkt.html" class="text-white hover:text-white">Hoe het werkt</a>
                        </li>
                ...
                <div class="lg:col-span-2 text-center sm:text-left">
                    ...
                    <ul class="text-sm transition-all duration-500">
                        <li class="mb-3"><a href="../index.html" class="text-white hover:text-white ">CheersTag.com</a>
                        </li>
