...
<body>
            ...
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="hidden md:flex flex-1 justify-center items-center mx-auto">
                    <div class="flex space-x-4">
                        <a href="../index.html"
                            class="text-[#722f37] hover:text-[#802311] px-3 py-2 text-sm font-semibold">Home</a>
    ...
    <section class="my-8 py-8">
        ...
        <div class="container flex-col justify-center mx-auto px-4 py-5 md:py-12 lg:py-10 lg:w-[50%]">
                ...
                <li class="flex justify-start shadow align-center rounded-md bg-white p-2">
                    <div class="flex items-center text-center gap-x-2">
                        <div class=" items-center p-2 rounded-full bg-[#f5e7d6] self-start">
                            <img src="../assets/icons/location.svg" alt="location" class="h-6 w-6  align-start ">
                        </div>
                        <div class="p-2">
